...
public class HelloController {
    ...
    @GetMapping("/hello")
    public String hello(@RequestParam(required = false, defaultValue = "Producer1") String name) {
        System.out.println("hello被调用");
        return "Hello, " + name + " from Producer1";
    }

    @GetMapping("/info")
    public String info() {
        System.out.println("info被调用");
        return "This is Producer1 service, instance ID: " + getInstanceId();
    }
